...
const calcDisplaySummary = function (movements) {                //------The magic of chaining---------------------
...
const multiplyWith2 = x => {
  return x * x;
};

const output = movements.map(multiplyWith2);
console.log(output); // [40000, 40000, 115600, 90000, 400, 462400, 2500, 160000, 211600]
